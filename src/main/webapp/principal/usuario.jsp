...
function buscarUsuario() {
	var nomeBusca = document.getElementById('nomeBusca').value;/*variavel nomeBusca pegando id que vem do input atributo id=nomeBusca*/
	
	if (nomeBusca != null && nomeBusca != '' && nomeBusca.trim() != '') { /*Validando que tem qeu ter valor para buscar no banco*/
		...
		$.ajax({
		     ...
		     success: function (response) {/*A mensagem na Servlet na validação do deletarajax - Excluído com sucesso será enviada para dentro deste response*/
			 
		    	 var json = JSON.parse(response);
		    	 
		    	 $('#tabelaresultados > tbody > tr') /*pegando pelo id # nossa tabeladeresultados*/
			  ...
			  //limparForm();Não precisa mais desse limpar pode apagar
			  //document.getElementById('msg').textContent = response;Não precisa também
		     }
...
function criarDelete() {
    ...
    if(confirm('Deseja realmente excluir os dados?')) {
	    ...
	    document.getElementById("formUser").method = 'get';/*pegando formulário e trocamos para o método get para enviar para o método doGet*/
	    document.getElementById("acao").value = 'deletar';/*Pegando o parametro acao e passando valor deletar*/
	    document.getElementById("formUser").submit();/*pegando o formulário e enviando ele*/
